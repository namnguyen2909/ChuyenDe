...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">    
    <div class="main_contain_css main_contain_css_1">
        ...
        <div class="bg_100pecents_css bg_button_css">
            <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-default" OnClick="btnDelete_Click" Text="Xóa"></asp:Button>
            <asp:Button ID="btnCreate" runat="server" OnClick="btnCreate_Click" CssClass="btn btn-warning" Text="Tạo mới"></asp:Button>            
        </div><br /><br />

        <div class="page-header"><h1 class="panel-title">Danh sách Người dùng</h1></div>        
        ...
        <div class="panel-body">
            <dx:ASPxGridView ID="grvUsers" Width="100%" runat="server" KeyFieldName="Id" OnDataBinding="grvUsers_DataBinding" Settings-ShowFilterRow="false"
                ...
                <Columns>                    
                    ...
                    <dx:GridViewDataColumn Caption="Họ tên" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left" VisibleIndex="0">
                        <DataItemTemplate>                                                
                            <a href="/Modules/UserDetails.aspx?userID=<%# Eval("id") %>"><%# Eval("FullName") %></a>
                        </DataItemTemplate>
                    </dx:GridViewDataColumn>

                    <dx:GridViewDataTextColumn FieldName="UserName" Caption="Tên đăng nhập" HeaderStyle-HorizontalAlign="Center" VisibleIndex="2" />                        
                    <dx:GridViewDataTextColumn FieldName="Email" Caption="Email" HeaderStyle-HorizontalAlign="Center" VisibleIndex="3" />
                    
                        
                    <dx:GridViewDataColumn Caption="Trạng thái" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left" VisibleIndex="4">
                        <DataItemTemplate>                                                
                            <%#((bool)Eval("isEnabled")==true) ? "Hoạt động":"Không hoạt động" %>
                        </DataItemTemplate>
                    </dx:GridViewDataColumn>
